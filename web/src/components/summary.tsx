        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-3">
            <li className="flex items-center gap-2">
              ...
              <p className="flex items-center text-xs underline underline-offset-2 text-zinc-500">
                Desfazer
              </p>
            </li>
            <li className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">
                ...
                ás <span className="text-zinc-100">09:13h</span>
              </span>
            ...
            <li className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">
                Você completou "
                <span className="text-zinc-100">Praticar exercícios</span>" ás{' '}
                <span className="text-zinc-100">11:13h</span>
              </span>
